...
-- at 2022-01-03T23:18:39.950431836Z                          --
----------------------------------------------------------------
    ...
    create table session (
       id bigint generated by default as identity,
        version bigint,
        end_time timestamp,
        estimated_average_waiting_duration bigint,
        label varchar(255),
        last_drawn_ticket_position integer not null,
    ...
    create table ticket (
       id bigint generated by default as identity,
        ...
        uuid_least_sig_bits bigint not null,
        uuid_most_sig_bits bigint not null,
    ...
    alter table ticket 
       add constraint UK_3kgqc94yvc3b564v5iodntq4e unique (uuid_least_sig_bits, uuid_most_sig_bits);
